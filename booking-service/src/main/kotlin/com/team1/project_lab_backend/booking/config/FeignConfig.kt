...
/**
 * Same OkHttp/LoadBalancer wiring gap as gateway/inventory-service's config/FeignConfig.kt
 * (Phase 2's finding) — this fictional spring-cloud-openfeign 5.0.2 has no OkHttp
 ...
 * wrapper the auto-config would have, with OkHttp as its delegate.
 */
@Configuration
class FeignConfig {
    @Bean
