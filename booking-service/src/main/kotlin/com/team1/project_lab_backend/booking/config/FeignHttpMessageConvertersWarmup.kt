 ...
 * incident writeup); applied here proactively since this module's own Feign client
 * (inventory-service, RoomFeignClient) is exposed to the exact same upstream bug.
 *
